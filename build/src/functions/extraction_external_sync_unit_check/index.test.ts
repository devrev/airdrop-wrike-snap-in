...
describe('External Sync Units Extraction Check Function', () => {
  ...
  it('should return success with valid_external_sync_unit_events=true for ExtractionExternalSyncUnitsStart event type', async () => {
    ...
    expect(result).toEqual({
      ...
      valid_external_sync_unit_events: true
    });
  ...
  it('should return success with valid_external_sync_unit_events=false for other extraction event types', async () => {
    ...
    expect(result).toEqual({
      status: 'success',
      message: 'External sync units extraction check function successfully invoked',
      valid_external_sync_unit_events: false
    });
  });
  ...
  it('should handle multiple events correctly', async () => {
    ...
    // Verify the result - should be true because at least one event is ExtractionExternalSyncUnitsStart
    expect(result).toEqual({
      status: 'success',
      message: 'External sync units extraction check function successfully invoked',
      valid_external_sync_unit_events: true
