...
export const createMockEvent = (): AirdropEvent => ({
  ...
  payload: {
    connection_data: {
      org_id: 'IEACW7SVI4O6BDQE', // Example Space ID from Postman collection
...
/**
 * Mock Wrike API response for space with members
 */
export const mockWrikeSpaceResponse = {
  data: [
    {
      id: 'IEACW7SVI4O6BDQE',
      title: 'Test Space',
...
/**
 * Mock Wrike API response for contacts
 */
export const mockWrikeContactsResponse = {
  data: [
    {
      id: 'KUAFY3BJ',
      firstName: 'John',
